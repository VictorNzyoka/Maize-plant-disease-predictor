...
public class ResultsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View navAccountLayout = headerView.findViewById(R.id.nav_account);
        if (navAccountLayout != null) {
            navAccountLayout.setOnClickListener(this::handleNavAccountClick);
        } else {
            // Handle the case where the nav_account LinearLayout is not found
            Toast.makeText(this, "nav_account LinearLayout not found", Toast.LENGTH_SHORT).show();
        }
    ...
    private void handleNavAccountClick(View view) {
        int id = view.getId();
        if (id == R.id.nav_home) {
            navigateToHome();
    ...
    private void navigateToHome() {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            Intent intentHome = new Intent(ResultsActivity.this, MainActivity.class);
    ...
    private void logout() {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            Intent intentLogout = new Intent(this, SignIn.class);
